...
<head>
    ...
    <!-- ① ANTI-FLASH: aplica fondo crema antes de que cargue el CSS -->
    <script>
...
<body class="login-page">
    ...
    <!-- ③ BOTÓN MODO: flotante esquina superior derecha, solo iconos -->
            ...
            <div class="logo-wrap">
                <div class="logo-ring-wrap">
                    ...
                    <div class="logo-circle">
                        <img src="logo/logo.png" alt="Logo Sodicol">
                    </div>
                </div>
    ...
    <script>
        ...
        document.querySelectorAll('button, a, input, label, .stat-chip').forEach(el => {
