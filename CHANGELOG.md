...
- Scripts de mantenimiento (`fix_db.php`, `check_uploads.php`, `unzip_images.php`) para corregir codificación de base de datos e importar imágenes en producción.
...
- **UI/UX**: Rediseño visual general utilizando tema claro (`light-theme`), efecto *glassmorphism* y micro-animaciones en tarjetas de productos/usuarios.
